<template>
	<el-button @click="onSelect('today')">今天</el-button>
	<el-button @click="onSelect('yesterday')">昨天</el-button>
	<el-button @click="onSelect('thisWeek')">本周</el-button>
	<el-button @click="onSelect('lastWeek')">上週</el-button>
	<el-button @click="onSelect('thisMonth')">本月</el-button>
	<el-button @click="onSelect('lastMonth')">上月</el-button>
</template>
